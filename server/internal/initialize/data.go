...
func initApiData() {
	...
	entities := []model.Api{
		...
		{Method: "GET", Path: "/api/v1/comment/article/getLikeStatus", Category: "评论回复", Desc: "获取文章评论点赞状态"},
		...
		{Method: "GET", Path: "/api/v1/comment/article/getDislikeStatus", Category: "评论回复", Desc: "获取文章评论点踩状态"},
		...
		{Method: "GET", Path: "/api/v1/comment/video/getLikeStatus", Category: "评论回复", Desc: "获取评论点赞状态"},
		...
		{Method: "GET", Path: "/api/v1/comment/video/getDislikeStatus", Category: "评论回复", Desc: "获取评论点踩状态"},
...
func initCasbinRuleData() {
	...
	entities := []model.CasbinRule{
		...
		{Ptype: "p", V0: "001", V1: "/api/v1/comment/article/getLikeStatus", V2: "GET"},
		...
		{Ptype: "p", V0: "001", V1: "/api/v1/comment/video/getLikeStatus", V2: "GET"},
		...
		{Ptype: "p", V0: "002", V1: "/api/v1/comment/article/getLikeStatus", V2: "GET"},
		...
		{Ptype: "p", V0: "002", V1: "/api/v1/comment/video/getLikeStatus", V2: "GET"},
...
var authApiDesc = map[string]string{
	...
	"GET|/api/v1/comment/article/getLikeStatus":        "获取文章评论点赞状态",
	...
	"GET|/api/v1/comment/video/getLikeStatus":      "获取视频评论点赞状态",
	// 弹幕
