...
// cid 为已解析好的文章数字 ID
func AddArticleComment(ctx *gin.Context, addCommentReq dto.AddCommentReq, cid uint) (vo.AddCommentResp, error) {
    ...
    // 发送回复通知
    InsertReplyMessage(addCommentReq, cid, comment.ID, userId, global.CONTENT_TYPE_ARTICLE)
